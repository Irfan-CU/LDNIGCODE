...
public:
	 ...
	 */
private:
	coord_tIrfan min_x1, min_y1, min_z1, max_x1, max_y1, max_z1;
	 ...
	 */
	void processDerivedWallsSkinInfill(SliceDataStorage& storage);
	 ...
	 */
	void processSkinsAndInfill(SliceDataStorage& storage, const int layer_nr, bool process_infill);
	...
	void processInsets(SliceDataStorage& storage, int layer_nr);
};
