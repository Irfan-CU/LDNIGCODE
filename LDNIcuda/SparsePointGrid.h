...
#include "SparseGrid.h"
	...
	public:
		 ...
		 */
		SparsePointGrid(coord_tIrfan cell_size, size_t elem_reserve = 0U, float max_load_factor = 1.0f);
...
#define SGI_THIS SparsePointGrid<ElemT, Locator>
	...
	SGI_TEMPLATE
		SGI_THIS::SparsePointGrid(coord_tIrfan cell_size, size_t elem_reserve, float max_load_factor)
	...
	{
		curaIrfan::PointIrfan loc = m_locator(elem);
