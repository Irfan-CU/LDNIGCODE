...
#include "Polygon.h"
	...
	public:
		 ...
		 */
		static ListPolyIt insertPointNonDuplicate(const ListPolyIt before, const ListPolyIt after, const curaIrfan::PointIrfan to_insert);
	};
...
//namespace cura
	...
	namespace std
	{
		 ...
		 */
		template <>
		struct hash<ListPolyIt>
		{
			size_t operator()(const ListPolyIt& lpi) const
			{
				return std::hash<curaIrfan::PointIrfan>()(lpi.p());
