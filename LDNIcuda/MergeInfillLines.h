...
public:
	 ...
	 */
	bool mergeInfillLines(std::vector<GCodePath>& paths, const curaIrfan::PointIrfan& starting_position) const;
...
private:
	 ...
	 */
	const coord_tIrfan nozzle_size;

	/*
	 * The allowed deviation in the line positioning.
	 */
	const coord_tIrfan maximum_deviation;

	/*
	 *
	 */
	coord_tIrfan calcPathLength(const curaIrfan::PointIrfan path_start, GCodePath& path) const;
	 ...
	 */
	bool mergeLinesSideBySide(const bool first_is_already_merged, GCodePath& first_path, const curaIrfan::PointIrfan first_path_start, GCodePath& second_path, const curaIrfan::PointIrfan second_path_start, curaIrfan::PointIrfan& new_first_path_start, coord_tIrfan& error_area) const;
	 ...
	 */
	bool tryMerge(const bool first_is_already_merged, GCodePath& first_path, const curaIrfan::PointIrfan first_path_start, GCodePath& second_path, const curaIrfan::PointIrfan second_path_start, curaIrfan::PointIrfan& new_first_path_start, coord_tIrfan& error_area) const;
};
