...
#include "SVG.h"
	...
	{
#ifdef DEBUG
		curaIrfan::PointIrfan last = poly.back();
#endif // DEBUG
	...
	{
		for (const curaIrfan::PointIrfan& p : list_polygon)
		{
			polygon.add(p);
		}
	}

	ListPolyIt ListPolyIt::insertPointNonDuplicate(const ListPolyIt before, const ListPolyIt after, const curaIrfan::PointIrfan to_insert)
	{
