...
#include "Slice.h"
#include "floatpoint.h" //For FMatrix3x3.
#include "logoutput.h"
#include "string.h" //For Escaped.
	...
	template<> coord_tIrfan Settings::get<coord_tIrfan>(const std::string& key) const
	{
