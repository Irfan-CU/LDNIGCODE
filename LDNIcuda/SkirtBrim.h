...
#include"Coord_tIrfan.h"
	...
	private:
		 ...
		 */
		static int generatePrimarySkirtBrimLines(const coord_tIrfan start_distance, size_t primary_line_count, const coord_tIrfan primary_extruder_minimal_length, const Polygons& first_layer_outline, Polygons& skirt_brim_primary_extruder);
	};
//namespace cura
