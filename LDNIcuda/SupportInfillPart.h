...
#include "Polygon.h"
	...
	public:
		...
		coord_tIrfan support_line_width;  //!< The support line width
		...
		SupportInfillPart(const PolygonsPart& outline, coord_tIrfan support_line_width, int inset_count_to_generate = 0);
