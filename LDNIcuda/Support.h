...
#define SUPPORT_H
	...
	public:
		 ...
		 */
		static bool handleSupportModifierMesh(SliceDataStorage& storage, const Slicer* slicer);
		 ...
		 */
		static void generateOutlineInsets(std::vector<Polygons>& insets, Polygons& outline, const unsigned int inset_count, const coord_tIrfan wall_line_width_x);
	...
	private:
		 ...
		 */
		static void generateSupportAreasForMesh(SliceDataStorage& storage,int mesh_idx, const size_t layer_count, std::vector<Polygons>& support_areas);
		 ...
		 */
		static void generateSupportInterfaceLayer(Polygons& support_areas, const Polygons mesh_outlines, const coord_tIrfan safety_offset, const coord_tIrfan outline_offset, const double minimum_interface_area, Polygons& interface_polygons);
		 ...
		 */
		static Polygons join(const SliceDataStorage& storage, const Polygons& supportLayer_up, Polygons& supportLayer_this, const coord_tIrfan smoothing_distance);
		 ...
		 */
		static void moveUpFromModel(const SliceDataStorage& storage, Polygons& stair_removal, Polygons& support_areas, const size_t layer_idx, const size_t bottom_empty_layer_count, const size_t bottom_stair_step_layer_count, const coord_tIrfan support_bottom_stair_step_width);
		 ...
		 * wall struts.
		 */
		static void handleWallStruts(Polygons& supportLayer_this);
