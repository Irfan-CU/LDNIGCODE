...
#include "Polygonutils.h"
	...
	private:
		...
		curaIrfan::PointIrfan middle; //!< The middle of the prime tower

		curaIrfan::PointIrfan post_wipe_point; //!< Location to post-wipe the unused nozzle off on
	...
	private:
		 ...
		 */
		void addToGcode_denseInfill(LayerPlan& gcode_layer, const size_t extruder,SliceDataStorage& storage) const;
		 ...
		 */
		void gotoStartLocation(LayerPlan& gcode_layer, const int extruder,SliceDataStorage& storage) const;
	};
