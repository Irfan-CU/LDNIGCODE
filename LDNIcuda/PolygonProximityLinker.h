...
#include "SparseLineGrid.h"
	...
	public:
		...
		typedef std::unordered_multimap<curaIrfan::PointIrfan, ProximityPointLink> Point2Link; //!< The type of PolygonProximityLinker::point_to_link
	...
	private:
		...
		{
			std::pair<curaIrfan::PointIrfan, curaIrfan::PointIrfan> operator()(const ListPolyIt& val) const
			{
				return std::pair<curaIrfan::PointIrfan, curaIrfan::PointIrfan>(val.p(), val.next().p());
			}
		};
		 ...
		 */
		ListPolyIt addNewPolyPoint(const curaIrfan::PointIrfan point, const ListPolyIt line_start, const ListPolyIt line_end, const ListPolyIt before_this);
		 ...
		 */
		int64_t proximityEndingDistance(curaIrfan::PointIrfan& a1, curaIrfan::PointIrfan& a2, curaIrfan::PointIrfan& b1, curaIrfan::PointIrfan& b2, int a1b1_dist);
		 ...
		 * \param it The value
		 */
		void addToPoint2LinkMap(curaIrfan::PointIrfan p, ProximityPointLinks::iterator it);
	...
	public:
		 ...
		 */
		bool isLinked(curaIrfan::PointIrfan from);
		 ...
		 */
		std::pair<PolygonProximityLinker::Point2Link::iterator, PolygonProximityLinker::Point2Link::iterator> getLinks(curaIrfan::PointIrfan from);
