...
AABB3D::AABB3D()
	...
	{
		return AABB(curaIrfan::PointIrfan(min.x, min.y), curaIrfan::PointIrfan(max.x, max.y));
	}
	...
	void AABB3D::includeZ(coord_tIrfan z)
	{
	...
	/*
	void AABB3D::offset(curaIrfan::PointIrfan offset)
	{
